...
*/
   ...
   TLatex* textLabelUp1 = new TLatex(0.53,0.77,"FPIX half disks");
   SetTextAll(textLabelUp1);
   textLabelUp1->Draw("same");


   TLatex* textLabel1 = new TLatex(0.35,0.25,"FPIX half disks");
   SetTextAll(textLabel1);
   textLabel1->Draw("same");

   TText* text_z2 = new TText(0.20,0.65,"");
   SetTextAlignmentLineUp(text_z2);
   text_z2->Draw("same");
   TText* text_z1 = new TText(0.20,0.60,"");
   ...
   c_z_vs_dz_PXF_1->SaveAs("z_vs_dz_PXF_1.pdf");
}
